---
title: "Homework - Probability"
author: "Math Camp"
date: "Fall 2017"
output: pdf_document
---

Each question assumes a standard deck of cards. Between each question,
assume that you put back whatever cards you drew in the previous and
shuffle the deck. 

For bonus points, use `rmarkdown` to output nicely-typeset
mathematical notation. For the calculation in #7, use an R code chunk
to get the answer. 
...
7. It rains 88 days of the year on average in Austin. The
