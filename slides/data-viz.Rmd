...
```{r}
p <- ggplot(data = gapminder) +
  geom_point(mapping = aes(x = gdpPercap, y = lifeExp)) + facet_grid(. ~ continent)
```
...
<!-- ```{r, FALSE} -->
<!-- p <- ggplot(data = gapminder, mapping = aes(x = gdpPercap, fill = continent)) + -->
<!--   geom_bar() -->
<!-- ``` -->
...
<!-- ```{r, echo = FALSE} -->
<!-- ggplot(data = gapminder, mapping = aes(x = , fill = continent)) + -->
