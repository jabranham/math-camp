...
* *Let's Make a Deal* was a game show where contestents were asked to choose one of three doors (A, B, and C). Behind one is a car and behind the other two are goats 
...
* WLOG assume contestent picks door $A$
* WLOG assume Monty opens door $B$
* Then: $Pr(B_{Monty}|A) = \dfrac{1}{2}$ and $Pr(B_{Monty}|B=0)$ and $Pr(C_{Monty}|C) = 1$
