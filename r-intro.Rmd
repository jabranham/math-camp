...
---
### 
> If you wanted to do foundational research in statistics in the mid-twentieth century, you had to be bit of a mathematician, whether you wanted to or not\ldots if you want to do statistical research at the turn of the twenty-first century,
...
* vs Stata
    ...
    + Documentation is sometimes not as clear (but you can see functions\ldots)
* vs other programming languages (e.g. Python, C++)
    + Uses lots of memory 
