...
* Non-plain text files may be unuseable 20 years from now
...
* For R: 
    + Markdown: [rmarkdown](https://www.rstudio.org/links/using_rmarkdown?version=0.99.473&mode=desktop)
    + LaTeX: [knitr]()
    + WYSIWYM: [Lyx + knitr]()
    + Office: [odfWeave]()
* For Stata: 
    + Google "Sweave for Stata"
